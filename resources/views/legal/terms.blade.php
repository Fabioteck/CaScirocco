...
<head>
    ...
    <title>Termini e Condizioni - Cà Scirocco</title>
...
<body class="bg-stone-50 text-stone-900 antialiased">
    ...
    <main class="min-h-screen py-12 md:py-16">
        <div class="max-w-4xl mx-auto px-6 bg-white p-8 md:p-12 shadow-sm border border-stone-100">
            ...
            <h1 class="font-serif text-4xl md:text-5xl italic text-stone-900 mb-8">Termini &amp; Condizioni</h1>
            
            <div class="prose prose-stone max-w-none text-stone-600 leading-relaxed text-sm">
                <p class="mb-6">Questa pagina contiene i termini e le condizioni di utilizzo dei servizi Cà Scirocco.</p>
            </div>
