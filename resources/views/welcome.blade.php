...
<nav x-data="{ open: false }" class="fixed top-0 left-0 w-full z-50 bg-white border-b border-stone-100 px-6 py-3">
    <div class="flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div class="hidden lg:flex items-center gap-8 text-[10px] font-bold uppercase tracking-widest text-stone-600">
            ...
            <a href="#prenota-tavolo" class="bg-stone-950 text-white px-8 py-3 rounded-full text-xs font-medium uppercase tracking-wider hover:bg-stone-800 transition-colors shadow-md">
                PRENOTA
            </a>
        </div>
        ...
        <div class="lg:hidden flex items-center">
            <button type="button" @click="open = !open" class="text-stone-950 hover:text-stone-700 focus:outline-none p-2">
    ...
    <div x-show="open" 
         ...
         class="lg:hidden bg-white border-t border-stone-100 py-6 flex flex-col gap-6 text-center text-[11px] font-bold uppercase tracking-widest text-stone-600 shadow-xl"
         style="display:none;">
        <a href="#ristorante" @click="open = false" class="hover:text-amber-800">Ristorante</a>
        <a href="#alloggi" @click="open = false" class="hover:text-amber-800">Alloggi</a>
        <a href="#staff" @click="open = false" class="hover:text-amber-800">Staff</a>
        <a href="#contatti" @click="open = false" class="hover:text-amber-800">Contatti</a>
        <a href="#prenota-tavolo" @click="open = false" class="mx-10 bg-stone-950 text-white py-3 rounded-full">PRENOTA</a>
    </div>
</nav>
...
<header class="relative h-screen w-full flex items-center justify-center overflow-hidden bg-stone-900">
    ...
    <div class="relative z-10 text-center px-6 max-w-5xl pt-20">
        ...
        <div class="flex flex-col sm:flex-row gap-5 justify-center items-center mb-16">
            <a href="tel:+39042622417" class="rounded-full py-3 px-6 text-xs font-medium uppercase tracking-wider transition-all duration-300 w-full sm:w-auto text-center border border-white/30 text-white backdrop-blur-md hover:bg-white/10">CHIAMACI</a>    
            <a href="#prenota-tavolo" class="rounded-full py-3 px-6 text-xs font-medium uppercase tracking-wider transition-all duration-300 w-full sm:w-auto text-center bg-amber-700 text-white hover:bg-amber-800 shadow-md">PRENOTA TAVOLO</a>
            <a href="#alloggi" class="rounded-full py-3 px-6 text-xs font-medium uppercase tracking-wider transition-all duration-300 w-full sm:w-auto text-center border border-white/30 text-white backdrop-blur-md hover:bg-white/10">PRENOTA STANZA</a>
        </div>
    </div>
